    ...
    <Navbar isBordered>
      ...
      <NavbarContent>
        <div className="flex w-full">
          ...
          <Link href="/teamstat/karabao/1485" className="w-full">
            <LeagueAvatarComponent
          ...
          <Link href="/teamstat/fa/1485" className="w-full">
            <LeagueAvatarComponent
